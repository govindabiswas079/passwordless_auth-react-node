...
const smsKey = process.env.TWILIO_MESSAGING_SERVICE_SID;
const twilioNum = process.env.TWILIO_PHONE_NUMBER;
const jwt = require('jsonwebtoken');

const JWT_AUTH_TOKEN = process.env.JWT_AUTH_TOKEN; // require('crypto').randomBytes(64).toString('hex') enter into terminal
const JWT_REFRESH_TOKEN = process.env.JWT_REFRESH_TOKEN;// require('crypto').randomBytes(64).toString('hex')
let refreshTokens = [];
